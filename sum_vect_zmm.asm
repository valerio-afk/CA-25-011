...
main:
    ...
    ;calculate reminder of the length of the file and 16 (number of 4byte ints in ZMM registers)
    mov eax, r15d
    xor edx,edx
    mov ecx, N_INT
    div ecx
    ...
    .sum_for_loop:
        ...
        vmovdqa32 zmm0, [r14+rdx*4]
        vmovdqa32 zmm1, [r13+rdx*4]

        vpaddd zmm0,zmm1 

        vmovdqa32 [rbx+rdx*4], zmm0
